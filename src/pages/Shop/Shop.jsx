        ...
        <div className="shop">
          {product
            ? product.map((element) => (
                <article key={element.id} className="card" style={{ width: "18rem" }}>
                  ...
                  <div className="card-img-top" style={{ height: "12rem", width: "18rem", overflow: "hidden" }}>
                    <img src={element.img} alt={element.title} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                  </div>
            ...
            : Array.from({ length: 3 }).map((_, index) => (
                <article key={index} className="card placeholder-card" aria-hidden="true" style={{ width: "18rem" }}>
                  <div className="card-price">
